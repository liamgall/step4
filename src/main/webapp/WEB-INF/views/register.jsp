...
<body>
	<div align="center">
		<table border="0" width="80%">
			<form:form id="form" action="/addUser" commandName="userVO"
				...
				<tr>
					...
					<td><form:input type="text" id="postcode5" path="postcode5"
							name="" class="postcodify_postcode5" style="width:50px"
							readonly="true" />
				...
				<tr>
					...
					<td><form:input type="text" id="address" path="address"
							name="" class="postcodify_address" style="width:300px"
							readonly="true" /></td>
				...
				<tr>
					...
					<td><form:input type="text" id="details" path="details"
							name="" class="postcodify_details" style="width:300px" /></td>
					<td><form:errors path="details" cssClass="error" /></td>
				</tr>
				<tr>
					<td>참고항목 :</td>
					<td><form:input type="text" id="extra_info" path="extra_info"
							name="" class="postcodify_extra_info" style="width:300px"
							readonly="true" /></td>
